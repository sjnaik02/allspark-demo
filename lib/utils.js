...
const caseCodeToName = {
  'GW': 'Garcia v. Wiseguy Towing',
  'GB': 'Gutierrez v. Bake Shop',
  'RA': 'Ramon v. ACME Widgets',
  'SM': 'Smith v. Magic Wash',
};
...
export function groupFilesByCase(files) {
  ...
  files.forEach(file => {
    ...
    const caseCode = fileNameParts[fileNameParts.length - 1].slice(0, 2).toUpperCase();
